...
<body id="body" onload="if (typeof(startup) !== 'undefined') startup();" style="overflow-y:hidden;margin:0;padding:0;border:0;font-size:13px;font-family:\'Trebuchet MS\', Arial, Helvetica, sans-serif">
                        ...
                        <div id="termTable" style="position:absolute;top:0;bottom:0;left:0;right:0">
                            <div id="termarea1">
                                <div class="areaHead" style="line-height:24px">
                                    ...
                                    <div>
                                        <span id="connectbutton2span" style="margin-left:3px"><input type="button" id="connectbutton2" cmenu="termConnectButton" value="つなぐ" style="height:28px" onclick="connectTerminal(event,1)" onkeypress="return false" onkeydown="return false" disabled="disabled"></span>
    ...
    <script>
        ...
        var keyStrings = { 8: "BackSpace", 9: "タブ", 13: "入る", 27: "エスケープ", 44 : "印刷画面", 45: "入れる", 46: "デル", 36: "家", 35: "終わり", 33: "ページアップ", 34: "ページダウン", 37: "左", 38: "アップ", 39: "右", 40: "下", 0: "なし" }
                ...
                if (data[0] == '{') {
                    ...
                    switch (j.action) {
                        case 'sshauth': {
                            ...
                            x += '</div>';
                            x += '<label><input id=dp2keep type=checkbox>' + "クレデンシャルを覚えておく" + '</label>';
